                ...
                <div class="navbar">
                  ...
                  <div id="main-nav" class="stellarnav d-flex justify-content-end right">
                    <ul class="menu-list">
                      ...
                      <!-- <li>
                        <a href="contact.html" class="item-anchor" data-effect="Contact">Category</a>
                      </li> -->



                      <!-- <li class="menu-item has-sub">
                        <a href="#" class="item-anchor d-flex align-item-center" data-effect="Pages">Accessories<i class="icon icon-chevron-down"></i></a>
                        <ul class="submenu">
                      ...
                      <li>
                        <a href="contact.html" class="item-anchor" data-effect="Contact">Cart</a>
                      </li>
