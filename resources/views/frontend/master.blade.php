    ...
    <section id="featured-products" class="product-store padding-large">
      <div class="container">
        <div class="section-header d-flex flex-wrap align-items-center justify-content-between">
          <h2 class="section-title">{{$section_title}} ( {{$allCategory->count()}} )</h2>            
          <div class="btn-wrap">
            <a href="shop.html" class="d-flex align-items-center">View all {{$section_title}} <i class="icon icon icon-arrow-io"></i></a>
          </div>            
        </div>
            ...
            <div class="swiper-slide">
              <div class="product-item">
                <div class="image-holder">
                  <img src="{{url('/upload/category/'.$category->image)}}" alt="Books" class="product-image">
                </div>
                ...
                <div class="product-detail">
                  ...
                  <span class="item-price text-primary">{{$category->price}}</span>
                </div>
              </div>
            </div>
          @endforeach
